...
const translations = {
  en: {
    ...
    "nav.protocol": "README",
    "hero.eyebrow": "TypeSafe AI · System One · project showcase",
    "hero.titleLead": "Explore",
    "hero.titleEmphasis": "Jev projects & ideas.",
    "hero.lede": "A structured, bilingual showcase of papers, software, demos, interviews, and public materials related to TypeSafe AI Jev. Browse the collection by type, platform, relationship, or topic.",
    "hero.primaryAction": "Browse the catalogue",
    "hero.secondaryAction": "View the README",
    "hero.statusLabel": "COLLECTION STATUS",
    "hero.statusValue": "CURATED SHOWCASE",
    ...
    "catalog.aside": "Browse by type, platform, and relationship. Dynamic metrics are shown only with an explicit as-of date.",
    ...
    "footer.note": "Static, bilingual showcase of the Jev ecosystem.",
    ...
    "status.viewDetails": "View relationship and evidence",
    "status.openCanonical": "Open canonical source",
    ...
    "evidence.probableNote": "Credible source; cross-check still pending",
    "evidence.candidateNote": "Discovery item not yet in the main register",
    "relation.uses_jev": "Directly uses or evaluates Jev",
    "relation.jev_inspired": "Inspired by Jev or System One ideas",
  ...
  zh: {
    ...
    "nav.catalog": "目录",
    "nav.protocol": "README",
    "hero.eyebrow": "TypeSafe AI · System One · 项目展示",
    "hero.titleLead": "探索",
    "hero.titleEmphasis": "Jev 项目与想法。",
    "hero.lede": "一个双语、结构化的 Jev 展示目录，汇集论文、软件、视频演示、访谈与公开材料。可按类型、平台、关系或主题浏览。",
    "hero.primaryAction": "浏览目录",
    "hero.secondaryAction": "查看 README",
    "hero.statusLabel": "目录状态",
    "hero.statusValue": "精选展示",
    "hero.scopeLabel": "范围",
    "scope.label": "范围",
    ...
    "catalog.kicker": "研究目录",
    "catalog.title": "记录",
    "catalog.aside": "按类型、平台与关系浏览。动态指标仅在明确标注截至日期时展示。",
    ...
    "status.viewDetails": "查看关系与证据",
    "status.openCanonical": "打开 canonical 来源",
    ...
    "evidence.probableNote": "来源可信，但仍待交叉核验",
    "evidence.candidateNote": "发现线索，尚未进入主目录",
    "relation.uses_jev": "直接使用或评测 Jev",
    "relation.jev_inspired": "受 Jev 或 System One 思路启发",
